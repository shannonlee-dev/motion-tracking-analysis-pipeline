...
| 로컬 파일 | 원본 시나리오 | 사용 목적 |
| --- | --- | --- |
| `single_1_overlap_1.mpg` | Meet_WalkSplit | 두 사람 만남·겹침·분리, 필수 약 25초 영상 |
...
`data/`·`results/`를 일괄 제외하지 않으며 가상환경·캐시·비밀 설정·`data/raw/`의 재생성 가능한 원본·아래 허가 미확인 자료를 `.gitignore`로 제외합니다.
